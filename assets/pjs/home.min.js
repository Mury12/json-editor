...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"row",attrs:{"id":"table"}},[_c('div',{staticClass:"col-12"},[_c('div',{staticClass:"row"},[_c('form',{on:{"submit":function($event){return _vm.save($event)}}},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-12 col-sm-6"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.item.conta),expression:"item.conta"}],staticClass:"form-control",attrs:{"type":"text","placeholder":"Numero da conta"},domProps:{"value":(_vm.item.conta)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.item, "conta", $event.target.value)}}}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.item.nome),expression:"item.nome"}],staticClass:"form-control",attrs:{"type":"text","placeholder":"Nome da conta"},domProps:{"value":(_vm.item.nome)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.item, "nome", $event.target.value)}}}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.item.robo),expression:"item.robo"}],staticClass:"form-control",attrs:{"type":"text","placeholder":"Valor do robô"},domProps:{"value":(_vm.item.robo)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.item, "robo", $event.target.value)}}})]),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-6"},[_c('input',{directives:[{name:"mask",rawName:"v-mask",value:(['% ##/##/####']),expression:"['% ##/##/####']"},{name:"model",rawName:"v-model",value:(_vm.item.termino),expression:"item.termino"}],staticClass:"form-control",attrs:{"type":"text","placeholder":"Data de término"},domProps:{"value":(_vm.item.termino)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.item, "termino", $event.target.value)}}}),_vm._v(" "),_c('input',{directives:[{name:"mask",rawName:"v-mask",value:(['* ##/##/####']),expression:"['* ##/##/####']"},{name:"model",rawName:"v-model",value:(_vm.item.term_renovacao),expression:"item.term_renovacao"}],staticClass:"form-control",attrs:{"type":"text","placeholder":"Data de término renovação"},domProps:{"value":(_vm.item.term_renovacao)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.item, "term_renovacao", $event.target.value)}}}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.item.observacao),expression:"item.observacao"}],staticClass:"form-control",attrs:{"type":"text","placeholder":"Observações"},domProps:{"value":(_vm.item.observacao)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.item, "observacao", $event.target.value)}}}),_c('br')])]),_vm._v(" "),_c('button',{staticClass:"btn btn-success",attrs:{"type":"submit"}},[_vm._v("Salvar")])])]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('vue-table',{attrs:{"items":_vm.items},on:{"delete":function($event){return _vm.handleDelete($event)},"edit":function($event){return _vm.handleEdit($event)}}})],1)])])}
...
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('thead',[_c('th',[_vm._v("Contas")]),_vm._v(" "),_c('th',[_vm._v("Nome")]),_vm._v(" "),_c('th',[_vm._v("Robô")]),_vm._v(" "),_c('th',[_vm._v("Data Término")]),_vm._v(" "),_c('th',[_vm._v("Data Término Renovação")]),_vm._v(" "),_c('th',[_vm._v("Observações")]),_vm._v(" "),_c('th',[_vm._v("Ação")])])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
